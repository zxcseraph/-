...
create index "informix".idx_smlog_mcnnumber5ft_old on "informix".mcn_smlogtemp_old 
    (mcnnumber) using btree  in userdbs;
create index "informix".idx_smlog_usernumber5ft_old on "informix".mcn_smlogtemp_old 
    (usernumber) using btree  in userdbs;
create index "informix".idx_smlog_streamnumber5ft on "informix".mcn_smlogtemp_old 
    (usernumber) using btree  in userdbs;

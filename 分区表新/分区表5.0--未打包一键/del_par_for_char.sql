drop procedure del_par_for_char;
create procedure del_par_for_char(p_tabname varchar(50))
        ...
        set debug file to '/tmp/del_par_for_char.dbg';
        trace on;
		let v_procname='del_par_for_char';
...
--execute procedure del_par_for_char('mcn_contralogtest');
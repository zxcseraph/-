...
declare -A truecrbthostname=(["CLAS11"]="clas11" ["CLAS31"]="clas31" ["NCCN11"]="nccn11" ["NCCN12"]="nccn12" ["NCCN13"]="nccn13" ["NCCN21"]="nccn21" ["NCCN22"]="nccn22" ["NCCN23"]="nccn23" ["NCCN31"]="nccn31" ["NCCN32"]="nccn32" ["NCCN33"]="nccn33")
...
#视频原始文件主机名，同音频
declare -A truevrbthostname=(["AS31"]="as31")

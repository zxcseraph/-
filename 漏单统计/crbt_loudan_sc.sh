#!/bin/sh
dodir=/data/loudan/workdir         			#脚本工作目录，所有操作均会在这个目录执行
...
new0wucha=10															#音频最终文件中000000000000的个数与前一天的误差百分比，高于这个就告警
newerrgeshu=10000000													#音频最终文件中000000000000的个数，高于这个就告警
...
crbtorifilenames=("AS201" "AS202" "AS221" "CAS031" "CAS032" "CAS033"  "CAS041" "CAS042" "CAS051" "CAS052" "CAS061" "CAS062"  "CN161" "CN162" "CN163" "CN164" "CN171" "CN172" "CN173" "CN174" "CN181" "CN182" "CN183" "CN184" "CN191" "CN192" "CN211" "CN212" "CN231" "CN232")
#音频文件存放目录
crbtfiledir=/data/log/image/data/TonePlayInfo
#音频原始文件存放目录
crbtfileoridir=/data/file
#音频文件临时工作目录
...
#视频文件存放目录
vrbtfiledir=/home/icaa/loudan/scziyuan/vrbt
#视频原始文件存放目录
vrbtfiledir=/home/icaa/loudan/scziyuan/vrbtyuanshi
#视频文件临时工作目录

...
dodir=/home/executor2/CDSS_1.0.0_linux_x64_rhel/loudan    #脚本工作目录，所有操作均会在这个目录执行
shengfencode=27                         #省份id，天津是02
...
servername=cdssdb11                     #数据库servername
...
crbtorifilenames=("CN11" "CN12" "CN21" "CN22" "CN31" "CN32" "IPDB21" "IPDB22" "CLDB31" "CLDB32" "CATAS3" "CATAS4")
#音频文件存放目录
crbtfiledir=/home/executor2/CDSS_1.0.0_linux_x64_rhel/log/image/data/TonePlayInfo
#音频原始文件存放目录
crbtfileoridir=/home/executor2/CDSS_1.0.0_linux_x64_rhel/data
#音频文件临时工作目录
...
#视频原始文件主机名，同音频
declare -A truevrbthostname=(["LZCATAS42BEB"]="GS-lzcatas42beb")
vrbtorifilenames=("AS41" "AS42")
#视频文件存放目录
vrbtfiledir=/home/executor2/loudan/GSziyuan/vrbt
#视频原始文件存放目录
vrbtfileoridir=/home/executor2/loudan/GSziyuan/vrbtyuanshi
#视频文件临时工作目录

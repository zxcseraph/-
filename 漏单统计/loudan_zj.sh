#!/bin/sh
dodir=/home/webjoin/loudan          	#脚本工作目录，所有操作均会在这个目录执行
shengfencode=11                         #省份id，浙江是11
...
servername=appdb92                      #数据库servername
databasename=iip                       #数据库的实例名   比如newip@dbm1，newip就是实例名，dbm1就是servername
...
declare -A truecrbthostname=(["ZJHZ-CL-CN111"]="zjhz-cl-cn111" ["ZJHZ-CL-CN112"]="zjhz-cl-cn112" ["ZJHZ-CL-CN113"]="zjhz-cl-cn113" ["ZJHZ-CL-CN114"]="zjhz-cl-cn114" ["ZJHZ-CL-CN115"]="zjhz-cl-cn115" ["ZJHZ-CL-CN116"]="zjhz-cl-cn116" ["ZJHZ-CN121"]="zjhz-cn121" ["ZJHZ-CN122"]="zjhz-cn122" ["ZJHZ-CN123"]="zjhz-cn123" ["ZJHZ-CN124"]="zjhz-cn124" ["ZJHZ-CN125"]="zjhz-cn125" ["ZJHZ-CN126"]="zjhz-cn126" ["ZJHZ-CN141"]="zjhz-cn141" ["ZJHZ-CN142"]="zjhz-cn142" ["ZJHZ-CN143"]="zjhz-cn143" ["ZJHZ-CN144"]="zjhz-cn144" ["ZJHZ-CN145"]="zjhz-cn145" ["ZJHZ-CN146"]="zjhz-cn146" ["ZJHZ-CN151"]="zjhz-cn151" ["ZJHZ-CN152"]="zjhz-cn152" ["ZJHZ-CN153"]="zjhz-cn153" ["ZJHZ-CN154"]="zjhz-cn154" ["ZJHZ-CN155"]="zjhz-cn155" ["ZJHZ-CN156"]="zjhz-cn156")
crbtorifilenames=("ZJHZ-CL-CN111" "ZJHZ-CL-CN112" "ZJHZ-CL-CN113" "ZJHZ-CL-CN114" "ZJHZ-CL-CN115" "ZJHZ-CL-CN116" "ZJHZ-CN121" "ZJHZ-CN122" "ZJHZ-CN123" "ZJHZ-CN124" "ZJHZ-CN125" "ZJHZ-CN126" "ZJHZ-CN141" "ZJHZ-CN142" "ZJHZ-CN143" "ZJHZ-CN144" "ZJHZ-CN145" "ZJHZ-CN146" "ZJHZ-CN151" "ZJHZ-CN152" "ZJHZ-CN153" "ZJHZ-CN154" "ZJHZ-CN155" "ZJHZ-CN156" "cn21" "cn22" "cn23" "cn24" "cn25" "cn26")
#音频文件存放目录
crbtfiledir=/home/cdss/cds/log/image/data/TonePlayInfo/
#音频原始文件存放目录
crbtfileoridir=/home/cdss/data/log
#音频文件临时工作目录
...
#视频原始文件主机名，同音频
declare -A truevrbthostname=(["AS01"]="as01")
vrbtorifilenames=("AS01")
#视频文件存放目录
vrbtfiledir=/home/webjoin/logfile/bak
#视频原始文件存放目录
vrbtfileoridir=/home/webjoin/logfile/baklog
#视频文件临时工作目录
...
crbtinitfile()
{
	...
	do
	    ...
	    then
	    	SendAlarm "$key 没有对应网管主机名，暂时文件名为其文件主机名" crbt
...
vrbtinitfile()
{
	...
	do
	    ...
	    then
	    	SendAlarm "$key 没有对应网管主机名，暂时文件名为其文件主机名" vrbt

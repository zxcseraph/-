...
dodir=/tmp/loudan/workdir					#脚本工作目录，所有操作均会在这个目录执行
...
#音频相关
#音频彩铃呼叫话单文件命名规则
crbtfile="VGOP_TONEPLAYINFO_${d1dayago}_${shengfencode}_txt.rar"
#音频原始文件命名规则
crbtorifile="*.SRF.LOG.${d1dayago}*"
#音频原始文件主机名如果需要区分到账户，则是主机加账户名
crbtorifilenames=("AS201_ringcopy" "AS221_ringcopy" "CAS041_ringcopy" "CAS042_ringcopy" "CAS051_ringcopy" "CAS052_ringcopy" "CAS061_ringcopy" "CAS062_ringcopy" "CN131_iip01" "CN132_iip01" "CN133_iip01" "CN134_iip01" "CN141_iip01" "CN142_iip01" "CN143_iip01" "CN144_iip01" "CN161_iip01" "CN162_iip01" "CN163_iip01" "CN164_iip01" "CN171_iip01" "CN172_iip01" "CN173_iip01" "CN174_iip01" "CN181_iip01" "CN182_iip01" "CN183_iip01" "CN184_iip01" "CN191_iip01" "CN192_iip01" "CN211_iip01" "CN212_iip01" "CN231_iip01" "CN232_iip01")
#音频文件存放目录
crbtfiledir=/tmp/loudan/ziyuan/crbt
#音频原始文件存放目录
crbtfileoridir=/tmp/loudan/ziyuan/crbtyuanshi
#音频文件临时工作目录
...
#视频原始文件主机名，同音频
vrbtorifilenames=("CAS033_ringcopy" "CAVTAS01_ringcopy" "CAS073_ringcopy")
#视频文件存放目录
vrbtfiledir=/tmp/loudan/ziyuan/vrbt
#视频原始文件存放目录
vrbtfileoridir=/tmp/loudan/ziyuan/vrbtyuanshi
#视频文件临时工作目录
